> **Migration status:** Legacy umbrella security policy retained as evidence. `docs/product/SECURITY_REPORTING.md` and platform security suites are authoritative.
