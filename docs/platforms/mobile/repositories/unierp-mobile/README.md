> **Repository evidence:** Relocated from `unierp-mobile/README.md`. This file may describe local setup, contribution or history but cannot override the owning product/platform suite.
...
**Layer L5 — Client** of the [UniERP](https://github.com/kannan19302/unierp-platform) platform.
