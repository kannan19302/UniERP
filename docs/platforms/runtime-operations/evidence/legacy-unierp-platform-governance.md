> **Migration status:** Legacy umbrella-repository governance; current documentation governance is authoritative.
...
Maintainers are expected to uphold the non-negotiables (legacy reference: `CONTRIBUTING.md#the-non-negotiables`)
and the Code of Conduct (legacy reference: `CODE_OF_CONDUCT.md`), and to say "I don't know" in
