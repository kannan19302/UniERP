> **Migration status:** Operational runbook migrated from the retired workspace. Roles, contacts and escalation paths require deployment-specific completion.
...
2. **Triage**: Determine severity (SEV-1 to SEV-3).
