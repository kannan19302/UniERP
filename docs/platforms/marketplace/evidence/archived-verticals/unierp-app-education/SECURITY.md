...
This service handles the **Education** industry extension for [UniERP](https://github.com/kannan19302/ERPSys).
It is reached exclusively through core's extension gateway (`/api/v1/ext/education/*`), authenticated by a
