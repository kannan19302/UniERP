...
This service handles the **Real Estate** industry extension for [UniERP](https://github.com/kannan19302/ERPSys).
It is reached exclusively through core's extension gateway (`/api/v1/ext/real-estate/*`), authenticated by a
