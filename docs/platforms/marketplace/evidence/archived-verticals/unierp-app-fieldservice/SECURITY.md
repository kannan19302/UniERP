...
Report suspected vulnerabilities privately via GitHub Security Advisories (legacy reference: `../../security/advisories/new`)
for this repository.
...
This service handles the **Field Service** industry extension for [UniERP](https://github.com/kannan19302/ERPSys).
It is reached exclusively through core's extension gateway (`/api/v1/ext/field-service/*`), authenticated by a
